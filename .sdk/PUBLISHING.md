...
|---|---|---|
| `ts/` | @voxgig-sdk/digimon-tcg-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/digimon-tcg-sdk \
      --repository voxgig-sdk/digimon-tcg-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/digimon-tcg-sdk` shows it, and
`npm trust revoke @voxgig-sdk/digimon-tcg-sdk --id=<id>` removes it.
