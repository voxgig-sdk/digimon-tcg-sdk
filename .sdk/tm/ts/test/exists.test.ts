...
describe('exists', async () => {
  ...
  //
  // DigimonTcgSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof DigimonTcgSDK, true,
      'DigimonTcgSDK.test() must return a client synchronously')
  })
