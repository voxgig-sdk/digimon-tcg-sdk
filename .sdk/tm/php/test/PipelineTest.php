...
{
    private static function utility(): DigimonTcgUtility
    {
        return new DigimonTcgUtility();
    }
    ...
    private static function ctx(array $over = []): DigimonTcgContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new DigimonTcgContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new DigimonTcgOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof DigimonTcgError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new DigimonTcgOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = DigimonTcgMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new DigimonTcgOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = DigimonTcgMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new DigimonTcgOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = DigimonTcgMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DigimonTcgSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = DigimonTcgMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new DigimonTcgResponse([]),
            'result' => new DigimonTcgResult([]),
        ]);
        [, $err] = DigimonTcgMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new DigimonTcgSpec([]),
            'response' => null,
            'result' => new DigimonTcgResult([]),
        ]);
        [, $err] = DigimonTcgMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new DigimonTcgSpec(['step' => 's']),
            'response' => new DigimonTcgResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new DigimonTcgResult([]),
        ]);
        [, $err] = DigimonTcgMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new DigimonTcgSpec(['step' => 's']),
            'response' => new DigimonTcgResponse(self::resp(200, ['v' => 1])),
            'result' => new DigimonTcgResult([]),
        ]);
        [, $err] = DigimonTcgMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new DigimonTcgSpec(['step' => 's']),
            'response' => new DigimonTcgResponse(self::resp(200, ['v' => 2])),
            'result' => new DigimonTcgResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        DigimonTcgMakeResponse::call($ctx);
    ...
    {
        $preset = new DigimonTcgResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new DigimonTcgSpec([]),
            'response' => new DigimonTcgResponse([]),
            'result' => new DigimonTcgResult([]),
        ...
        [$got, $err] = DigimonTcgMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new DigimonTcgResult([])]);
        [, $err] = DigimonTcgMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new DigimonTcgSpec([]), 'result' => null]);
        [, $err] = DigimonTcgMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DigimonTcgSpec(['step' => 's']),
            'result' => new DigimonTcgResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new DigimonTcgOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DigimonTcgMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new DigimonTcgSpec(['step' => 's']),
            'result' => new DigimonTcgResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new DigimonTcgOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = DigimonTcgMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new DigimonTcgResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new DigimonTcgSpec([]),
            'result' => new DigimonTcgResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = DigimonTcgMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DigimonTcgMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new DigimonTcgError('boom', 'boom');
        $utility->fetcher = function (DigimonTcgContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DigimonTcgSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = DigimonTcgMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (DigimonTcgContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = DigimonTcgMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(DigimonTcgResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        DigimonTcgMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (DigimonTcgContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new DigimonTcgSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = DigimonTcgMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new DigimonTcgResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new DigimonTcgSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = DigimonTcgMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = DigimonTcgMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = DigimonTcgMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new DigimonTcgResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, DigimonTcgDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new DigimonTcgResult(['ok' => false])]);
        $this->expectException(DigimonTcgError::class);
        DigimonTcgDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new DigimonTcgResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', DigimonTcgMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        DigimonTcgMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new DigimonTcgBaseFeature();
        $b = new DigimonTcgBaseFeature();
        DigimonTcgFeatureAdd::call($ctx, $a);
        DigimonTcgFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): DigimonTcgBaseFeature
    {
        $f = new DigimonTcgBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        DigimonTcgFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): DigimonTcgContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new DigimonTcgSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = DigimonTcgPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        DigimonTcgPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new DigimonTcgResponse(['headers' => null]),
            'result' => new DigimonTcgResult([]),
        ]);
        DigimonTcgResultHeaders::call($ctx);
