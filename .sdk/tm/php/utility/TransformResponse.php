...
// DigimonTcg SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DigimonTcgTransformResponse
{
    public static function call(DigimonTcgContext $ctx): mixed
    {
        ...
        $transform = DigimonTcgHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
