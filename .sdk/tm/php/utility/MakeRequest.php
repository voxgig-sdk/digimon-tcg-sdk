...
// DigimonTcg SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DigimonTcgMakeRequest
{
    public static function call(DigimonTcgContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DigimonTcgResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DigimonTcgResponse($fetched);
        } else {
