...
// DigimonTcg SDK utility: graphql
//
...
class DigimonTcgGraphql
{
    ...
    // equivalent.
    public static function body(DigimonTcgContext $ctx): mixed
    {
    ...
    public static function errors(DigimonTcgContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
