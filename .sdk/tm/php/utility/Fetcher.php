...
// DigimonTcg SDK utility: fetcher

class DigimonTcgFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DigimonTcgSDK/1.0)';
    ...
    public static function call(DigimonTcgContext $ctx, string $fullurl, array $fetchdef): array
    {
