...
// DigimonTcg SDK timeout feature
...
class DigimonTcgTimeoutFeature extends DigimonTcgBaseFeature
{
    ...
    private function _with_timeout(DigimonTcgContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DigimonTcgContext $_ctx, float $ms): void
    {
        $client = $this->client;
