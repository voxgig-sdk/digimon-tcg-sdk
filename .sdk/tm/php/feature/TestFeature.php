...
// DigimonTcg SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DigimonTcgTestFeature extends DigimonTcgBaseFeature
{
    ...
    public function init(DigimonTcgContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DigimonTcgContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DigimonTcgParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DigimonTcgContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DigimonTcgContext $ctx, $op, $args): array
    {
