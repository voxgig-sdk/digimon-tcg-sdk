...
// DigimonTcg SDK clienttrack feature
...
class DigimonTcgClienttrackFeature extends DigimonTcgBaseFeature
{
    ...
    public function PostConstruct(DigimonTcgContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DigimonTcg-SDK';
