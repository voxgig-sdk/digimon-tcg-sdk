...
class DigimonTcgCacheFeature extends DigimonTcgBaseFeature
{
    ...
    private function _through(DigimonTcgContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
