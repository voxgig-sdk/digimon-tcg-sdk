...
class DigimonTcgProxyFeature extends DigimonTcgBaseFeature
{
    ...
    public function init(DigimonTcgContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DigimonTcgContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
