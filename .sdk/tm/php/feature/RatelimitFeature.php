...
// DigimonTcg SDK ratelimit feature
...
class DigimonTcgRatelimitFeature extends DigimonTcgBaseFeature
{
    ...
    private function _acquire(DigimonTcgContext $ctx): void
    {
    ...
    private function _track(DigimonTcgContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
