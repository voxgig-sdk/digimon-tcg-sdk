...
This API allows you to retrieve information for Digimon Cards from the Digimon TCG.

Learn more about Digimon TCG API at [digimoncard.io](https://digimoncard.io).

This is an unofficial SDK for the Digimon TCG public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — GetAllCard and Search — that you
...
const items = await client.GetAllCard().list()
```
...
```go
client := sdk.Test()
result, err := client.GetAllCard(nil).List(
    nil, nil,
)
```
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/digimon-tcg-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/digimon-tcg-sdk/releases) |
| Python | `voxgig-sdk-digimon-tcg` | publish pending — [install from git tag](https://github.com/voxgig-sdk/digimon-tcg-sdk/releases) |
| PHP | `voxgig-sdk/digimon-tcg` | publish pending — [install from git tag](https://github.com/voxgig-sdk/digimon-tcg-sdk/releases) |
| Golang | `github.com/voxgig-sdk/digimon-tcg-sdk/go` | `go get github.com/voxgig-sdk/digimon-tcg-sdk/go@latest` |
| Ruby | `voxgig-sdk-digimon-tcg` | publish pending — [install from git tag](https://github.com/voxgig-sdk/digimon-tcg-sdk/releases) |
| Lua | `voxgig-sdk-digimon-tcg` | publish pending — [install from git tag](https://github.com/voxgig-sdk/digimon-tcg-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/digimon-tcg-sdk/go-cli` | `go install github.com/voxgig-sdk/digimon-tcg-sdk/go-cli/cmd/digimon-tcg@latest` |
| Go MCP server | `github.com/voxgig-sdk/digimon-tcg-sdk/go-mcp` | `go get github.com/voxgig-sdk/digimon-tcg-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **GetAllCard** | The GetAllCard entity (list). | `/getAllCards.php` |
...
$getallcards = $client->GetAllCard()->list();
print_r(array_map(fn($item) => $item->data_get(), $getallcards));
```
