...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/digimon-tcg` | `npm install @voxgig-sdk/digimon-tcg` |
| Python | `voxgig-sdk-digimon-tcg` | `pip install voxgig-sdk-digimon-tcg` |
| PHP | `voxgig-sdk/digimon-tcg` | `composer require voxgig-sdk/digimon-tcg` |
| Golang | `github.com/voxgig-sdk/digimon-tcg-sdk/go` | `go get github.com/voxgig-sdk/digimon-tcg-sdk/go` |
| Ruby | `voxgig-sdk-digimon-tcg` | `gem install voxgig-sdk-digimon-tcg` |
| Lua | `voxgig-sdk-digimon-tcg` | `luarocks install voxgig-sdk-digimon-tcg` |
