...
// instead of `sdk.NewDigimonTcgSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DigimonTcgSDK  { return NewDigimonTcgSDK(nil) }
func Test() *DigimonTcgSDK { return TestSDK(nil, nil) }
