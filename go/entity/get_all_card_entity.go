...
type GetAllCardEntity struct {
	name    string
	client  *core.DigimonTcgSDK
...
func NewGetAllCardEntity(client *core.DigimonTcgSDK, entopts map[string]any) *GetAllCardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetAllCardEntity) GetName() string { return e.name }
...
func (e *GetAllCardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetAllCardEntity) Deleted() bool {
	return e.deleted
}


func (e *GetAllCardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetAllCardEntity(e.client, opts)
}

func (e *GetAllCardEntity) Data(args ...any) any {
...
func (e *GetAllCardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetAllCard; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetAllCardEntity) DataTyped(data ...GetAllCard) GetAllCard {
	if len(data) > 0 {
		return typedFrom[GetAllCard](e.Data(asMap(data[0])))
	}
	return typedFrom[GetAllCard](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetAllCard (all fields
// optional at the wire level).
func (e *GetAllCardEntity) MatchTyped(match ...GetAllCard) GetAllCard {
	if len(match) > 0 {
		return typedFrom[GetAllCard](e.Match(asMap(match[0])))
	}
	return typedFrom[GetAllCard](e.Match())
}
...
func (e *GetAllCardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetAllCardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetAllCardEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetAllCardListMatch and returns []GetAllCard. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetAllCardEntity) ListTyped(reqmatch GetAllCardListMatch, ctrl map[string]any) ([]GetAllCard, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetAllCard](res), nil
}



func (e *GetAllCardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetAllCardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetAllCardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetAllCardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
