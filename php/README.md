...
print_r(array_map(fn($item) => $item->data_get(), $getallcard));
```
...
```
php/
├── digimontcg_sdk.php          -- Main SDK class
...
The main class (`digimontcg_sdk.php`) exports the SDK class
