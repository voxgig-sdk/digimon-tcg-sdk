...
class DigimonTcgRbacFeature extends DigimonTcgBaseFeature
{
    ...
    private function _required(DigimonTcgContext $ctx): ?string
    {
    ...
    private function _reject(DigimonTcgContext $ctx, string $required): void
    {
    ...
    private function _track(DigimonTcgContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
