...
class DigimonTcgTestRunner
{
    ...
    {
        $live = self::getenv('DIGIMON_TCG_TEST_LIVE');
        $override = self::getenv('DIGIMON_TCG_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DIGIMON_TCG_TEST_EXPLAIN');
...
class_alias('DigimonTcgTestRunner', 'Runner');
class_alias('DigimonTcgHelpers', 'Helpers');
