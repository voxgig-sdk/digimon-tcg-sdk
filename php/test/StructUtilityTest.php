...
// DigimonTcg SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DigimonTcgOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DigimonTcgOmni::structfix($now, Struct::undef()))
                        !== json_encode(DigimonTcgOmni::structfix($val, Struct::undef()))) {
