...
// DigimonTcg SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DigimonTcgSDK::test)
...
{
    private const SDK_CLASS = 'DigimonTcgSDK';
    ...
    private const SDK_BASE = 'digimontcg_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../digimontcg_sdk.php';
