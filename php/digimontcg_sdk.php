...
class DigimonTcgSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = DigimonTcgHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = DigimonTcgHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!DigimonTcgFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, DigimonTcgFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return DigimonTcgUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = DigimonTcgHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = DigimonTcgHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = DigimonTcgHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new DigimonTcgError($op . "_allow",
                "DigimonTcgSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = DigimonTcgHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new DigimonTcgError("graphql_error",
                "DigimonTcgSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function GetAllCard($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_get_all_card === null) {
                $this->_get_all_card = new GetAllCardEntity($this, null);
            }
            return $this->_get_all_card;
        }
        return new GetAllCardEntity($this, $data);
    }
