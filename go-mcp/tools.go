...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_all_card | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DigimonTcgSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "digimon-tcg_list",
		Description: "List records from DigimonTcg. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "digimon-tcg_load",
		Description: "Load a single record from DigimonTcg. " +
...
func runOp(client *sdk.DigimonTcgSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DigimonTcgSDK, name string) (sdk.DigimonTcgEntity, error) {
	switch strings.ToLower(name) {
	case "get_all_card":
		return client.GetAllCard(nil), nil
	case "search":
