// Command DigimonTcg-mcp is an MCP server exposing the DigimonTcg
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DigimonTcg_list  — list records of an entity
//	DigimonTcg_load  — load a single record of an entity
//
