...
class DigimonTcgTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DigimonTcgTestRunner.getenv("DIGIMONTCG_TEST_LIVE")
        override = DigimonTcgTestRunner.getenv("DIGIMONTCG_TEST_OVERRIDE")
        ...
        explain = DigimonTcgTestRunner.getenv("DIGIMONTCG_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["DIGIMONTCG_TEST_EXPLAIN"] = explain
