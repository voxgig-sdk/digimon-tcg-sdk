# DigimonTcg SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DigimonTcgSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DigimonTcgSDK(...) and DigimonTcgSDK.test(...) become
#      DigimonTcgSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "digimontcg_sdk"
_SDK_CLASS = "DigimonTcgSDK"
