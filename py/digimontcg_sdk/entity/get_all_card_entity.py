...
from digimontcg_sdk.digimontcg_types import (
    GetAllCard,
    GetAllCardListMatch,
)
...
class GetAllCardEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetAllCardEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetAllCard]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetAllCard().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
