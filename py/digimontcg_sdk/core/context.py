...
from digimontcg_sdk.core.helpers import get_ctx_prop, to_map
...
class DigimonTcgContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DigimonTcgSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DigimonTcgResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DigimonTcgResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DigimonTcgError(code, msg, self)
