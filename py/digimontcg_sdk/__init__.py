...
from digimontcg_sdk.utility import register

# Load features
from digimontcg_sdk.feature.base_feature import DigimonTcgBaseFeature
from digimontcg_sdk.features import _has_feature, _make_feature
...
class DigimonTcgSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DigimonTcgUtility()
        self._utility = utility

        from digimontcg_sdk.config import shared_config
    ...
    def get_utility(self):
        return DigimonTcgUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DigimonTcgSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetAllCard(self, data=None) -> "GetAllCardEntity":
        ...
        from digimontcg_sdk.entity.get_all_card_entity import GetAllCardEntity
        return GetAllCardEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from digimontcg_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "DigimonTcgSDK":
        if sdkopts is None:
            sdkopts = {}
