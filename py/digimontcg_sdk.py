...
from core.utility_type import DigimonTcgUtility
...
class DigimonTcgSDK:
    ...
    def get_all_card(self):
        ...
        cached = getattr(self, "_get_all_card", None)
        if cached is None:
            cached = GetAllCardEntity(self, None)
            self._get_all_card = cached
        return cached

    def GetAllCard(self, data=None):
