...
local GetAllCardEntity = {}
GetAllCardEntity.__index = GetAllCardEntity


function GetAllCardEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetAllCardEntity)
  self._name = "get_all_card"
  self._client = client
...
function GetAllCardEntity:get_name()
  return self._name
end


function GetAllCardEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetAllCardEntity.new(self._client, opts)
end
...
function GetAllCardEntity:mark_deleted()
  self._deleted = true
end


function GetAllCardEntity:deleted()
  return true == self._deleted
end


function GetAllCardEntity:data_set(args)
  if args ~= nil then
...
function GetAllCardEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetAllCardEntity:match_set(args)
  if args ~= nil then
...
function GetAllCardEntity:match_get()
...
function GetAllCardEntity:stream(action, args, callopts)
...
---@param reqmatch GetAllCardListMatch
---@param ctrl? table
---@return GetAllCard[]
---@return string? err
function GetAllCardEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GetAllCardEntity:_run_op(ctx, post_done)
  local utility = self._utility
