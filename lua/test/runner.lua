...
function runner.env_override(m)
  local live = runner.getenv("DIGIMON_TCG_TEST_LIVE")
  local override = runner.getenv("DIGIMON_TCG_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DIGIMON_TCG_TEST_EXPLAIN")
