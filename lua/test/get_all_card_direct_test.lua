...
describe("GetAllCardDirect", function()
  it("should direct-list-get_all_card", function()
    local setup = get_all_card_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_all_card", setup.live and "live" or "unit")
...
function get_all_card_direct_setup(mockres)
