# DigimonTcg TypeScript SDK



The TypeScript SDK for the DigimonTcg API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.GetAllCard()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `DigimonTcgSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DigimonTcgSDK.test(testopts?, sdkopts?)` | `DigimonTcgSDK` | Create a test-mode client. |
...
digimon-tcg/
├── src/
│   ├── DigimonTcgSDK.ts        # Main SDK class
