...
(0, node_test_1.describe)('GetAllCardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DigimonTcgSDK({
    ...
    (0, node_test_1.test)('direct-list-get_all_card', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_all_card', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.DIGIMON_TCG_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DigimonTcgSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DIGIMON_TCG_TEST_GET_ALL_CARD_ENTID'];
    ...
    const client = new __1.DigimonTcgSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetAllCardDirect.test.js.map