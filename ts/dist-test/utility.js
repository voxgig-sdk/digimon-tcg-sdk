...
function envOverride(m) {
    if ('TRUE' === process.env.DIGIMON_TCG_TEST_LIVE ||
        'TRUE' === process.env.DIGIMON_TCG_TEST_OVERRIDE) {
    ...
    m.DIGIMON_TCG_TEST_EXPLAIN = process.env.DIGIMON_TCG_TEST_EXPLAIN || m.DIGIMON_TCG_TEST_EXPLAIN;
    return m;
}
