...
require_relative 'DigimonTcg_types'
...
class DigimonTcgSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = DigimonTcgHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = DigimonTcgHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, DigimonTcgFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    DigimonTcgUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = DigimonTcgHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = DigimonTcgHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = DigimonTcgHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = DigimonTcgHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = DigimonTcgError.new(
        "graphql_error", "DigimonTcgSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
