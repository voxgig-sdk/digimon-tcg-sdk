...
AQL-driven CLI and REPL for the DigimonTcg SDK. Positional arguments are
...
./digimon-tcg-cli load 1 get_all_card
./digimon-tcg-cli load '{id:1}' get_all_card
