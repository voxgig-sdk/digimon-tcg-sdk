...
func registerSDKWords(r *eng.Registry, client *sdk.DigimonTcgSDK) {
...
func runOp(client *sdk.DigimonTcgSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
